...
# TODO: Add Repository BY MOVE CINEMA / Check ASYNC 
class GetIncomingMovieShowtimesUseCase:
    ...
    async def execute(self, cinema_id=None, movie_id=None) -> List[MovieShowtime]:
        ...
        return await self._generate_movie_showtimes_dto(movies, incoming_show_times)

    async def _generate_movie_showtimes_dto(
        self, 
        movies: List[Movie], 
